...
$active = "Account";
include("db.php");
include("functions.php"); #Adds helper functions
include("header.php");
?>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb-text product-more">
                    ...
                    <a href="index.php"><i class="fa fa-home"></i> Home</a> <!--Contains a link back to the homepage (index.php)-->
                    <span>Account</span>
                </div>
            </div>
        </div>
...
<!-- user account details and orders details -->
