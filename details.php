...
if (isset($_GET['details'])) { #Checks if the details parameter

    $emal = $_SESSION['customer_email'];
    $query = "select * from customer where customer_email = '$emal'"; #Prepares an SQL query to fetch the customer's details
