...
<section class="hero-section"> <!-- Displays the slider on the homepage.-->
...
<!-- Banner Section Begin. Displays category banners for Men, Women, and Kids -->
...
<!-- Women Banner Section Begin.Highlights Women's products with a large banner image and a product carousel -->
...
#Displays a welcome message using a GET parameter stat when a user logs in.
if (isset($_GET['stat'])) {
