...
if (isset($_SESSION['customer_email'])) {  #ensures the customer logged in
    ...
    ";
    #Displays the orders in a table with columns for
    while ($row_items = mysqli_fetch_array($run_items)) { #Retrieves the full customer record from the customer table using the email.
